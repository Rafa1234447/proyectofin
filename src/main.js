...
/* =============================
   CONFIG
============================= */
const API_BASE = "https://api-vrcm.onrender.com"; // tu API
/*
const ENDPOINTS = {
...
async function getStatus() {
  try {
    ...
    const res = await fetch("https://api-vrcm.onrender.com/status", {
      headers: authHeaders(),
    });
...
async function turnOn() {
  try {
    lightError.classList.add("d-none");
    await fetch("https://api-vrcm.onrender.com/turn-on", {
      method: "POST",
      headers: authHeaders(),
    });
    renderLight("on");
...
async function turnOff() {
  try {
    lightError.classList.add("d-none");
    await fetch("https://api-vrcm.onrender.com/turn-off", {
      method: "POST",
      headers: authHeaders(),
    });
    renderLight("off");
